const siteExamples = [
...

    {
        ...
        description: 'Buttarsi nel mondo della vendita di cover è un azzardo senza un sito dove poter vendere e far ordinare i loro prodotti preferiti. Il punto forte del sito è la sua modernità che porta il visitatore a volerlo scoprire in ogni sua parte',
        imageURL: process.env.PUBLIC_URL + '/assets/NegozioDiCoverPresentation.jpg',
    },
];
